...
var authApi = __webpack_require__(11);
...
var checkWin = function checkWin(cells, player) {
  if (gameData.game.over === false) {
    if (cells[0] === player && cells[4] === player && cells[8] === player || cells[2] === player && cells[4] === player && cells[6] === player || cells[0] === player && cells[1] === player && cells[2] === player || cells[3] === player && cells[4] === player && cells[5] === player || cells[6] === player && cells[7] === player && cells[8] === player || cells[0] === player && cells[3] === player && cells[6] === player || cells[1] === player && cells[4] === player && cells[7] === player || cells[2] === player && cells[5] === player && cells[8] === player) {
...
var game = function game(event) {
  if (gameData.game.over === false && $(event.target).text() === '') {
    ...
    turnCount += 1;
    gameApi.updateGame(gameData).then(updateGameSuccess).catch(gameUi.updateGameFailure);
  }
};
...
var onStartNewGame = function onStartNewGame(event) {
  ...
  $('.box').text('');
  $('h1').text('Play Tic-Tac-Toe!');
  gameApi.createGame().then(gameUi.newGameSuccess).catch(gameUi.newGameFailure);
};

var onGetGames = function onGetGames(event) {
  event.preventDefault();
  gameApi.indexGames().then(gameUi.indexGameSuccess).catch(gameUi.indexGameFailure);
};
...
var indexGameSuccess = function indexGameSuccess(data) {
  var totalcompletedgames = data.games.length;
